...
@section('title', 'Document Signer | Digital In-Corporation')
@section('description', '')
          ...
          <div class="col-12 col-md-6 col-lg-4 d-flex">
            ...
            <div class="card mb-6 shadow-light-lg lift lift-lg">
              ...
              <a class="card-img-top" href="#!">
                ...
                <!-- Image -->
                <img src="{{asset ('assets/ui/img/photos/photo-15.jpg')}}" alt="..." class="card-img-top">
              ...
              <a class="card-meta mt-auto" href="#!">
                ...
                <div class="avatar avatar-sm mr-2">
                  <img src="{{asset ('assets/ui/img/avatars/avatar-1.jpg')}}" alt="..." class="avatar-img rounded-circle">
                </div>
          ...
          <div class="col-12 col-md-6 col-lg-4 d-flex">
            ...
            <div class="card mb-6 shadow-light-lg lift lift-lg">
              ...
              <a class="card-img-top" href="#!">
                ...
                <!-- Image -->
                <img src="{{asset ('assets/ui/img/photos/photo-14.jpg')}}" alt="..." class="card-img-top">
              ...
              <a class="card-meta mt-auto" href="#!">
                ...
                <!-- Avatar -->
                <div class="avatar avatar-sm mr-2">
                  <img src="{{asset ('assets/ui/img/avatars/avatar-2.jpg')}}" alt="..." class="avatar-img rounded-circle">
                </div>
          ...
          <div class="col-12 col-md-6 col-lg-4 d-flex">
            ...
            <div class="card mb-6 shadow-light-lg lift lift-lg">
              ...
              <a class="card-img-top" href="#!">
                ...
                <!-- Image -->
                <img src="{{asset ('assets/ui/img/photos/photo-7.jpg')}}" alt="..." class="card-img-top">
          ...
          <div class="col-12 col-md-6 col-lg-4 d-flex">
            ...
            <div class="card mb-6 mb-lg-0 shadow-light-lg lift lift-lg">
              ...
              <a class="card-img-top" href="#!">
                ...
                <!-- Image -->
                <img src="{{asset ('assets/ui/img/photos/photo-6.jpg')}}" alt="..." class="card-img-top">
          ...
          <div class="col-12 col-md-6 col-lg-4 d-flex">
            ...
            <div class="card shadow-light-lg lift lift-lg">
              ...
              <a class="card-img-top" href="#!">
                ...
                <!-- Image -->
                <img src="{{asset ('assets/ui/img/photos/photo-5.jpg')}}" alt="..." class="card-img-top">
