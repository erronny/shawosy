...
<br><br>
                            ...
                            {{ Form::open(array('url' => 'admin/imageuploader','enctype'=>'multipart/form-data','autocomplete'=>"off")) }}
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12"></div>
                ...
                <div class="sparkline12-graph">
                  ...
                  <td id="td3"><input type="file" name="name[]"   onchange="loadPreview(this)" accept="image/png, image/jpeg, image/gif, image/tiff, image/image/svg+xml, image/webp, image/apng, image/avif" multiple >
                    </td>
                  </tr>
                  </table>
                  </div>
